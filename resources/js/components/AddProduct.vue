    ...
    <div class="m-auto w-1/2 mt-10">
        <form @submit.prevent="submit">
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" v-model="fields.name" name="product_name" id="product_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" v-model="fields.description" name="product_description" id="product_description" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="number" min="0" v-model="fields.price" name="product_price" id="product_price" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="file" @change="fields.picture" accept="image/*" name="product_picture" id="product_picture" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
                <label for="product_picture" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Foto</label>
            </div>
...
export default {
    ...
    methods: {
        submit() {
            axios
                .post("/store/product", this.fields)
                .then(() => {
                    router.push('home');
                })
                .catch((error) => {
